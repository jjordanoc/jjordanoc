...
Over the past few years, I've worked across startups and research: building SyntaxAI, a real-time AI English tutor used by thousands of learners, proposing new multi-agent evaluation systems using LLMs, and researching 3D generative models. My work sits at the intersection of Trustworthy AI across modalities (vision, language) and applied production systems.
